...
<div class="container-fluid">
   <div class="row align-items-center pt-2">
      ...
      <div class="col-lg-6 col-sm-6 text-center">
         <h1 class="font-27 fw-bold text-uppercase text-purple">STUDENT NOTES AND PAPER ANSWERS</h1>
         
         @if(is_array($studentData) && isset($studentData['full_name'], $studentData['grade']['gname']))
             <p class="font-20 fw-500 text-purple">< {{ $studentData['full_name'] }} > - < {{ $studentData['grade']['gname'] }} ></p>
         @else
           ...
           <div class="col-lg-3 col-sm-4 mb-3 align-items-center">
              <div class="border-new pt-3 pb-5 px-3 rounded-35 bg-white text-center">
                 <div class="row justify-content-center pt-2 pb-3">
                    <div class="col-8">
                       <img class="d-block w-100" src="{{ asset('themes/default/img/note-paper.png') }}" alt="Guru Niwasa LMS">
                    </div>
                 </div>
